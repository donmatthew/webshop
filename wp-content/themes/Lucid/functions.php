...
function et_home_posts_query( $query = '' ) {
	...
	if ( 'false' == et_get_option('lucid_use_pages','false') && 'false' == et_get_option('lucid_duplicate','on') ){
		...
		$query->set( 'post__not_in', $et_featured_post_ids );
	}
}
